...
set JAVA_VERSION=17
set MAIN_JAR=inventory-1.0-SNAPSHOT.jar
...
"%JAVA_HOME%\bin\jdeps" ^
  ...
  --print-module-deps target\classes\mo\inventory\InventoryApplication.class > temp.txt
...
call "%JAVA_HOME%\bin\jpackage" ^
  ...
  --name Inventory ^
  --main-class mo.inventory.InventoryApplication ^
  --main-jar %MAIN_JAR% ^
  --java-options -Xmx2048m ^
  --icon src/main/resources/images/telegraico.ico ^
  --runtime-image target/java-runtime 
 rem --vendor "Fezas." ^
 rem --copyright "Copyright © 2019-21 Fezas" ^
 rem --win-dir-chooser ^
